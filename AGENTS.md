...
- **Never invent** a Bedrock model ID, Strands API, SDK method, CLI flag or config key. Look it up in the official docs (Strands: https://strandsagents.com, Bedrock console/docs, Supermemory: https://supermemory.ai/docs, Picovoice docs) and cite the URL in your hand-off report.
