...
| D19 | 2026-09-14 | Wake word: **sherpa-onnx open-vocabulary keyword spotting** instead of Picovoice | Picovoice's free tier ended 30 June 2026; sherpa-onnx is open source, on-device, needs no account/key/training; push-to-talk remains the backup | §7.1, §9.1 |
