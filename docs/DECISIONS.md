...
| D4 | 2026-09-14 | Models: **rules → Nova Micro** router; **Sonnet 5** orchestrator, computer use, PPT content; **Haiku 4.5** screen description and summaries; no image generation (D21) | Fast where the user waits, best quality where they don't; Nova Micro and Nova 2 Lite swaps only if they pass §17.1b quality gates | §10, §10.1 |
...
| D24 | 2026-09-14 | Voice stack pinned to `strands-agents[bidi,bidi-pyaudio,bidi-aec,otel]==1.55.1` + `brew install portaudio`, echo cancellation on, bidi behind an adapter | Verified in package source; experimental API with planned renames | AUDIT B1–B4 |
| D25 | 2026-09-14 | **Pending owner decision:** Claude via Pay By Invoice (billed outside credits) vs Nova-only on credits | Promotional credits exclude Marketplace; AISPL Marketplace payment restrictions | AUDIT A2 |
