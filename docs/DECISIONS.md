...
| D17 | 2026-09-14 | Regions: **`ap-south-1` (Mumbai)** for Claude, Nova Micro and Nova Canvas via cross-region inference profiles; **`ap-northeast-1` (Tokyo)** for Nova 2 Sonic. Phase 0 measures latency and may move Sonic to `us-east-1` or `us-west-2` | Owner is in Bangalore; Nova 2 Sonic is only offered in us-east-1, us-west-2, ap-northeast-1 (and some EU regions), not Mumbai | §13.5.4 |
